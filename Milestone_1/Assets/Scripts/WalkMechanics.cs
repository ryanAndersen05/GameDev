...
public class WalkMechanics : MonoBehaviour {
	...
	void updateVelocity() {
		...
		Vector3 goalVelocity = inputDirection * speed * scale + new Vector3(0, velocity.y, 0);

		velocity = Vector3.Lerp (velocity, goalVelocity, Time.deltaTime * velSmoothing);
	...
	public bool getIsWalking() {
		return Mathf.Abs (velocity.x) > .001f || Mathf.Abs (velocity.z) > .001f;
	}
